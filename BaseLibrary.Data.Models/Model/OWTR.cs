...
namespace BaseLibrary.Data.Models.Model
{
    ...
    public partial class OWTR
    {
        ...
        [StringLength(10)]
        public string U_STOKDURUMU { get; set; }
        public int? U_SEVKIYATDURUMU { get; set; }
        [StringLength(10)]
        public string U_KDVMUAF { get; set; }
        [StringLength(10)]
        public string U_FINSPORSEKTOR { get; set; }
        [StringLength(120)]
        public string U_ODEMESEKLI { get; set; }
        [StringLength(10)]
        public string U_SATISKANALI { get; set; }
        [StringLength(10)]
        public string U_SPONSORDURUM { get; set; }
        public DateTime? U_IMZATARIHI { get; set; }
        [StringLength(15)]
        public string U_MAHKEME { get; set; }
        [StringLength(20)]
        public string U_MAHKEME1 { get; set; }
        [StringLength(10)]
        public string U_MADDESAYISI { get; set; }
        [StringLength(10)]
        public string U_SATINALMASEKLI { get; set; }
        [StringLength(10)]
        public string U_SATALMAOSEKLI { get; set; }
        [StringLength(10)]
        public string U_NAKLIYETIPI { get; set; }
        [StringLength(10)]
        public string U_BEDELLI { get; set; }
        public DateTime? U_FSEVKTARIH { get; set; }
        [StringLength(10)]
        public string U_SIGORTAPOLNO { get; set; }
        public DateTime? U_FGELISTARIH { get; set; }
        [StringLength(10)]
        public string U_VARLIMYER { get; set; }
        [StringLength(10)]
        public string U_TEDARIKCIADI { get; set; }
        [StringLength(15)]
        public string U_TEDSIPARISNO { get; set; }
        public int? U_TEDFATNO { get; set; }
        [Column(TypeName = "numeric")]
        public decimal? U_PAZGELIRI { get; set; }
        [Column(TypeName = "numeric")]
        public decimal? U_KOMTUTAR { get; set; }
        [Column(TypeName = "numeric")]
        public decimal? U_VADEFARKI { get; set; }
        [Column(TypeName = "numeric")]
        public decimal? U_REKLAMTUTARI { get; set; }
        [Column(TypeName = "numeric")]
        public decimal? U_KARGOBEDN11 { get; set; }
        [Column(TypeName = "numeric")]
        public decimal? U_KARGOBEDFINSPOR { get; set; }
        [Column(TypeName = "numeric")]
        public decimal? U_IADEKARBED { get; set; }
        [Column(TypeName = "numeric")]
        public decimal? U_HIZBEDELI { get; set; }
        [Column(TypeName = "numeric")]
        public decimal? U_GFHIZBEDELI { get; set; }
        [Column(TypeName = "numeric")]
        public decimal? U_IADEKOMBEDELI { get; set; }
        [Column(TypeName = "numeric")]
        public decimal? U_IADEKARBEDFIN { get; set; }
        [Column(TypeName = "numeric")]
        public decimal? U_TEDGECHEDCEK { get; set; }
        [Column(TypeName = "numeric")]
        public decimal? U_SATICIUCRETLERI { get; set; }
        [Column(TypeName = "numeric")]
        public decimal? U_ISLEMUCRETGIDERI { get; set; }
        [Column(TypeName = "numeric")]
        public decimal? U_IADETUTARI { get; set; }
        [Column(TypeName = "numeric")]
        public decimal? U_KAMPANYAINDTUTARI { get; set; }
        public int? U_FIRSATADI { get; set; }
        [StringLength(20)]
        public string U_SATISBOLGESI { get; set; }
        [StringLength(10)]
        public string U_UYARIDURUMU { get; set; }
        [StringLength(25)]
        public string U_ImportFolderNo { get; set; }
        [StringLength(25)]
        public string U_ManifestNo { get; set; }
        public DateTime? U_ManifestDate { get; set; }
        public DateTime? U_ManifestTransDate { get; set; }
        public int? U_ManifestCost { get; set; }
        [StringLength(20)]
        public string U_Currency { get; set; }
        [StringLength(25)]
        public string U_Antrepo { get; set; }
        [StringLength(20)]
        public string U_Status { get; set; }
        [StringLength(25)]
        public string U_ImportSubFolderNo { get; set; }
        [Column(TypeName = "ntext")]
        public string U_Comment { get; set; }
        [StringLength(10)]
        public string U_TEDARIKCIKODU { get; set; }
        [StringLength(50)]
        public string U_UUID { get; set; }
        [StringLength(50)]
        public string U_InvoiceSeriesNum { get; set; }
        [StringLength(50)]
        public string U_InvoiceEnvelopeNum { get; set; }
        [StringLength(25)]
        public string U_InvoiceType { get; set; }
        [StringLength(25)]
        public string U_InvoiceProfile { get; set; }
        [StringLength(25)]
        public string U_SendInvoiceType { get; set; }
        [Column(TypeName = "ntext")]
        public string U_EFatNote { get; set; }
        [Column(TypeName = "ntext")]
        public string U_InvoiceStatus { get; set; }
        [Column(TypeName = "ntext")]
        public string U_InvoiceAnswerStatus { get; set; }
        [StringLength(50)]
        public string U_KDVTaxExemptionReasonInfo { get; set; }
        [StringLength(50)]
        public string U_OTVTaxExemptionReasonInfo { get; set; }
        [Column(TypeName = "ntext")]
        public string U_PaymentTerms { get; set; }
        [StringLength(1)]
        public string U_IsFreeInvoice { get; set; }
        [StringLength(5)]
        public string U_ERPStatus { get; set; }
        [StringLength(1)]
        public string U_ISArchived { get; set; }
        [StringLength(155)]
        public string U_DeliveryAdress { get; set; }
        [StringLength(155)]
        ...
        public DateTime? U_GTBRealExportDate { get; set; }
        [StringLength(50)]
        public string U_GCB_TescilNo { get; set; }
        [StringLength(23)]
        public string U_GTBRefNo { get; set; }
        [Column(TypeName = "ntext")]
        public string U_GTBAnswer { get; set; }
        [StringLength(50)]
        public string U_PayeeCode { get; set; }
        [StringLength(50)]
        public string U_PayeeChannelCode { get; set; }
        public DateTime? U_PayeeDueDate { get; set; }
        [StringLength(100)]
        public string U_PayeeFinAccountID { get; set; }
        [Column(TypeName = "ntext")]
        public string U_PayeeNote { get; set; }
        [StringLength(10)]
        public string U_EArvSalesPlatform { get; set; }
        [StringLength(10)]
        public string U_EArvSendType { get; set; }
        [StringLength(1)]
        public string U_EArvISDespatch { get; set; }
        [StringLength(50)]
        public string U_EArvWebSite { get; set; }
        [StringLength(25)]
        public string U_EArvPaymentMethod { get; set; }
        [Column(TypeName = "ntext")]
        public string U_EArvPaymentMethodName { get; set; }
        public DateTime? U_EArvPaymentDate { get; set; }
        [Column(TypeName = "ntext")]
        public string U_EArvTransporterName { get; set; }
        [Column(TypeName = "ntext")]
        public string U_EArvTrnsptRgstrNbr { get; set; }
        public DateTime? U_EArvTransportDate { get; set; }
        [StringLength(25)]
        public string U_UsingRateType { get; set; }
        public DateTime? U_TGelisTarih { get; set; }
        [StringLength(25)]
        public string U_SubFldr { get; set; }
    }
}

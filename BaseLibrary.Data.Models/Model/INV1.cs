namespace BaseLibrary.Data.Models.Model
{
    ...
    public partial class INV1
    {
        ...
        public int? U_GARANTISURE { get; set; }
        [StringLength(10)]
        public string U_MONTAJ { get; set; }
        [StringLength(10)]
        public string U_SEVK { get; set; }
        [StringLength(20)]
        public string U_TEMINSEKLI { get; set; }
        [StringLength(50)]
        public string U_DEGISCEKURUN { get; set; }
        [StringLength(155)]
        ...
        [StringLength(50)]
        public string U_ReasonCode { get; set; }
    }
}

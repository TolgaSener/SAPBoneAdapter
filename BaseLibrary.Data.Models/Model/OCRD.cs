namespace BaseLibrary.Data.Models.Model
{
    ...
    public partial class OCRD
    {
        ...
        [StringLength(20)]
        public string U_HANGIDEP { get; set; }
        [StringLength(20)]
        public string U_SATISBOLGESI { get; set; }
        public int? U_MAGAZANO { get; set; }
        [StringLength(50)]
        public string U_BaBsGrupKodu { get; set; }
        [StringLength(1)]
        public string U_ISEInvoiceCustomer { get; set; }
        [StringLength(1)]
        public string U_IsTcCitizen { get; set; }
        [StringLength(25)]
        public string U_InvoiceType { get; set; }
        [StringLength(25)]
        public string U_InvoiceProfile { get; set; }
        [StringLength(254)]
        public string U_ReceiverAlias { get; set; }
        [StringLength(25)]
        public string U_SendInvoiceType { get; set; }
        [StringLength(10)]
        public string U_SalesPlatform { get; set; }
        [StringLength(10)]
        public string U_SendType { get; set; }
        [StringLength(25)]
